...
data	segment									; data segment.
		myStr	db  'Hello World!', '$'		;Define a string terminated by $
		myStr2	db  'Hello again, World!', 10, '$'	;Define a string terminated by $
data	ends
...
;-------------------------------------------------------------------------------------------------------------------------------------------------------		
;****************** Write Code Here ******************
lea ax, myStr						;Load address of myStr
mov dx, ax							;Move address of string to dx for display later
